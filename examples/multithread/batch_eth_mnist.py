...
from bindsnet.models import DiehlAndCook2015, DiehlAndCook2015_MultiThreaded
...
parser.add_argument("--num_network_threads",type=int,default=-1)
...
# Build network.
network = DiehlAndCook2015_MultiThreaded(
    n_inpt=784,
    n_neurons=n_neurons,
    exc=exc,
    inh=inh,
